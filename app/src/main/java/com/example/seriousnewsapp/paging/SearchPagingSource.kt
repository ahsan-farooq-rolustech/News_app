...
class SearchPagingSource(private val repository: NewsRepository,private val q:String): PagingSource<Int, Article>()
{
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Article>
    {
        return try
        {
            ...
            val response=repository.getEveryThingTopic(q,currentPage)
