...
class DiscoveryPagingSource(private val repository: NewsRepository, private val country: String, private val category: String) : PagingSource<Int, Article>()
{
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Article>
    {
        return try
        {
            ...
            val response=repository.getCategory(country,currentPage,category)
